...
<li><strong>Étape 2: Effacer le cache des modifications</strong> - Après l\'installation, allez dans <strong>Extensions > Modifications</strong> et cliquez sur le bouton <strong>Rafraîchir</strong> pour effacer le cache des modifications. Cela garantit que l\'extension est bien intégrée dans votre système.</li>
<li><strong>Étape 3: Activer l\'extension pour votre magasin</strong> - Allez dans les paramètres de l\'extension et activez l\'extension pour chaque magasin où vous souhaitez utiliser les services IndexNow.</li>
<li><strong>Étape 4: Activer les services IndexNow pour votre magasin</strong> - Dans les paramètres de l\'extension, activez les services IndexNow pour le magasin sélectionné. Vous pouvez également choisir d\'activer ou de désactiver des services spécifiques d\'IndexNow pour chaque magasin.</li>
<li><strong>Étape 5: Configurer les options de notification aux moteurs de recherche</strong> - Activez ces options pour notifier les moteurs de recherche lorsque du contenu tel que des catégories, des produits, des fabricants ou des articles est ajouté, mis à jour ou supprimé. Cela garantit que les moteurs de recherche restent à jour.</li>
<li><strong>Étape 6: Régénérer la clé de service (facultatif)</strong> - Si nécessaire, vous pouvez régénérer votre clé de service pour chaque magasin séparément via les paramètres de l\'extension.</li>
<li><strong>Étape 7: Soumettre des URL</strong> - Soumettez des URL aux services IndexNow en soumettant les URL en file d\'attente, en important/téléchargeant votre plan de site XML ou en saisissant manuellement une URL et en la soumettant aux services IndexNow.</li>
<li><strong>Étape 8: Surveiller les journaux</strong> - Une fois les URL soumises, vous pouvez consulter l\'onglet Journal pour voir les résultats des soumissions. Vous pouvez également effacer le journal si nécessaire.</li></ul>';
